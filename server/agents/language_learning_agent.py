...
DO NOT define common words like "yes", "no", "he", "hers", "to", "from", "thank you", "please", "because", etc. Focus on rare words.
...
def run_language_learning_agent(conversation_context: str, word_rank: dict):
    ...
    class LanguageLearningAgentQuery(BaseModel):
        ...
        """
        translated_words: dict = Field(description="the target language words translated into source language words")
    ...
    extract_language_learning_agent_query_prompt = PromptTemplate(
        ...
        partial_variables={"format_instructions": language_learning_agent_query_parser.get_format_instructions()}
    )
